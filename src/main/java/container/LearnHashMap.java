...
public class LearnHashMap<K, V> extends LearnAbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
...
//		@SuppressWarnings({ "rawtypes", "unchecked" })
	...
	final class KeySet extends AbstractSet<K> {
		...
		public final Spliterator<K> spliterator() {
			return new KeySpliterator<>(LearnHashMap.this, 0, -1, 0, 0);
		}
	...
	final class Values extends AbstractCollection<V> {
		...
		public final Spliterator<V> spliterator() {
			return new ValueSpliterator<>(LearnHashMap.this, 0, -1, 0, 0);
		}
	...
	final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
		...
		public final Spliterator<Map.Entry<K, V>> spliterator() {
			return new EntrySpliterator<>(LearnHashMap.this, 0, -1, 0, 0);
		}
...
//			@SuppressWarnings({ "rawtypes", "unchecked" })
	...
	static class HashMapSpliterator<K, V> {
		...
		HashMapSpliterator(LearnHashMap<K, V> m, int origin, int fence, int est, int expectedModCount) {
			this.map = m;
			this.index = origin;
			this.fence = fence;
			this.est = est;
	...
	static final class KeySpliterator<K, V> extends HashMapSpliterator<K, V> implements Spliterator<K> {
		KeySpliterator(LearnHashMap<K, V> m, int origin, int fence, int est, int expectedModCount) {
	...
	static final class ValueSpliterator<K, V> extends HashMapSpliterator<K, V> implements Spliterator<V> {
		ValueSpliterator(LearnHashMap<K, V> m, int origin, int fence, int est, int expectedModCount) {
			super(m, origin, fence, est, expectedModCount);
		}
	...
	static final class EntrySpliterator<K, V> extends HashMapSpliterator<K, V> implements Spliterator<Map.Entry<K, V>> {
		EntrySpliterator(LearnHashMap<K, V> m, int origin, int fence, int est, int expectedModCount) {
			super(m, origin, fence, est, expectedModCount);
		}
	 ...
	 */
	static final class TreeNode<K, V> extends LearnLinkedHashMap.Entry<K, V> {
		 ...
		 */
		final Node<K, V> untreeify(LearnHashMap<K, V> map) {
		 ...
		 */
		final TreeNode<K, V> putTreeVal(LearnHashMap<K, V> map, Node<K, V>[] tab, int h, K k, V v) {
			Class<?> kc = null;
		 ...
		 */
		final void removeTreeNode(LearnHashMap<K, V> map, Node<K, V>[] tab, boolean movable) {
			int n;
		 ...
		 */
		final void split(LearnHashMap<K, V> map, Node<K, V>[] tab, int index, int bit) {
			TreeNode<K, V> b = this;
